...
## Instruções
Para escolher qual teste rodar usa-se como primeiro argumento o número equivalente de cada teste, 1 para o Teste 1, 2 para o Teste 2, 3 para o Teste 3.
...
- Na segunda, temos o mesmo parâmetro da primeira e em seguida n parâmetros, sendo cada um elemento do array de n elementos.
